...
simple_text
        :
        TE coords TEXT {var te = new paper.PointText({point: $2, fillColor: layers[0].layerColor, fontSize: 15, content: $3, fontFamily: 'Courier New'});
        }
        ;
%%
...
window.onload = function () {
  ...
  result = simpleTextExample.parse(input);
  paper.view.draw();
};
